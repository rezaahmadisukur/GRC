        ...
        <div class="px-6 py-5 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-white">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-slate-500">ID: {{ $car->id }}</p>
            </div>
          </div>
        </div>
        ...
        <form action="{{ route('admin.cars.update', $car) }}" method="POST" enctype="multipart/form-data"
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="group">
              ...
              <input type="text" id="category" name="category" value="{{ old('category', $car->category) }}"
            ...
            <div class="group">
              ...
              <div class="flex gap-3">
                <label class="flex-1 cursor-pointer">
                  <input type="radio" name="transmission" value="AT" class="peer sr-only" {{ old('transmission', $car->transmission) === 'AT' ? 'checked' : '' }}>
                  <div
                ...
                <label class="flex-1 cursor-pointer">
                  <input type="radio" name="transmission" value="MT" class="peer sr-only" {{ old('transmission', $car->transmission) === 'MT' ? 'checked' : '' }}>
                  <div
                    class="px-4 py-3.5 rounded-xl border border-slate-200 bg-slate-50 text-center font-medium text-slate-600 peer-checked:bg-blue-50 peer-checked:border-blue-500 peer-checked:text-blue-600 transition-all duration-200">
                    Manual (MT)
                  </div>
            ...
            <div class="group">
              ...
              <input type="number" id="seats" name="seats" value="{{ old('seats', $car->seats) }}" min="1" max="20"
            ...
            <div class="group">
              ...
              <input type="text" id="fuel_type" name="fuel_type" value="{{ old('fuel_type', $car->fuel_type) }}"
            ...
            <div class="md:col-span-2 group">
              ...
              <div
                ...
                @if($car->image)
                  <div class="mb-4">
                    <img src="{{ asset('storage/' . $car->image) }}" alt="Current vehicle image"
