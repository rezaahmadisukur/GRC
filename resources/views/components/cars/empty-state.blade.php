<div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-12 md:p-16 text-center">
  <div class="max-w-md mx-auto">
    ...
    <a href="{{ route('cars.index') }}"
      class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r dari-blue-600 ke-blue-700 hover:dari-blue-700 hover:ke-blue-800 text-white rounded-2xl transition-all duration-300 font-bold shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/50 hover:scale-105 active:scale-95">
