<footer class="relative bg-slate-950 overflow-hidden" id="contact">
  ...
  <div class="absolute inset-0 pointer-events-none select-none">
    ...
    <div class="absolute inset-0" style="background: radial-gradient(ellipse 70% 40% at 50% -5%, rgba(37,99,235,0.10), transparent);"></div>
    <div class="absolute inset-0 opacity-[0.03]"
      style="background-image: radial-gradient(circle, rgba(255,255,255,0.9) 1px, transparent 1px); background-size: 32px 32px;">
    </div>
  </div>
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 pt-14 pb-12 border-b border-white/[0.06]">
      ...
      <div class="lg:col-span-5 flex flex-col gap-5">
        ...
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-600/30"
        ...
        {{-- Description --}}
        <p class="text-sm leading-relaxed max-w-sm" style="color: #64748b;">
        ...
        <div class="flex items-center gap-2">
          <span class="text-xs font-semibold uppercase tracking-widest mr-1" style="color: #334155;">Ikuti kami</span>
          @php
            $socials = [
              [
                'label' => 'Instagram',
          ...
          @foreach($socials as $s)
            <a href="#" title="{{ $s['label'] }}"
              class="group w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5"
              style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08);"
              onmouseover="this.style.borderColor='{{ $s['border'] }}'; this.style.background='rgba(255,255,255,0.07)';"
      ...
      <div class="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-10 lg:pl-8">
        ...
        <div>
          ...
          <ul class="space-y-3.5">
            ...
            {{-- Lokasi --}}
            <li>
              <a href="https://maps.google.com/?q=Purwakarta,+Jawa+Barat" target="_blank"
                class="group flex items-start gap-3 transition-all duration-200">
                ...
                <div>
                  <p class="text-xs font-semibold uppercase tracking-widest mb-0.5" style="color: #334155;">Lokasi</p>
                  <p class="text-sm font-medium leading-snug transition-colors duration-200"
                    style="color: #64748b;"
                    onmouseover="this.style.color='#e2e8f0';"
                    onmouseout="this.style.color='#64748b';">
            ...
            <li>
              <a href="https://wa.me/6281234567890" target="_blank"
                ...
                <div>
                  <p class="text-xs font-semibold uppercase tracking-widest mb-0.5" style="color: #334155;">WhatsApp</p>
            ...
            {{-- Email --}}
            <li>
              <a href="mailto:info@grc-rental.com"
                class="group flex items-start gap-3 transition-all duration-200">
                <div class="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5"
                  style="background: rgba(139,92,246,0.08); border: 1px solid rgba(139,92,246,0.15);">
                  <svg class="w-3.5 h-3.5" style="color: #8b5cf6;" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <div>
                  <p class="text-xs font-semibold uppercase tracking-widest mb-0.5" style="color: #334155;">Email</p>
                  <p class="text-sm font-medium transition-colors duration-200"
                    style="color: #64748b;"
                    onmouseover="this.style.color='#e2e8f0';"
                    onmouseout="this.style.color='#64748b';">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 py-8 border-b border-white/[0.06]">
      <div>
        ...
        <p class="text-sm mt-0.5" style="color: #475569;">Respon cepat, proses mudah, harga transparan.</p>
      </div>
      <a href="https://wa.me/6281234567890" target="_blank"
        class="flex-shrink-0 inline-flex items-center gap-2.5 px-6 py-3 rounded-xl font-bold text-sm text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
        style="background: linear-gradient(135deg, #16a34a, #15803d); box-shadow: 0 4px 20px rgba(22,163,74,0.35);"
        onmouseover="this.style.boxShadow='0 8px 28px rgba(22,163,74,0.50)';"
        onmouseout="this.style.boxShadow='0 4px 20px rgba(22,163,74,0.35)';">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-3 py-6 text-xs">
      <p style="color: #334155;">
        © {{ date('Y') }}
        <span class="font-semibold" style="color: #475569;">Pusat Rentcar Purwakarta.</span>
        Semua hak dilindungi.
      </p>
      <div class="flex items-center gap-4" style="color: #334155;">
