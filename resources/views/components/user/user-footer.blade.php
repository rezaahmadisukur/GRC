    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 pt-14 pb-12 border-b border-white/[0.06]">
      ...
      <div class="lg:col-span-5 flex flex-col gap-5">
        ...
        <p class="text-sm leading-relaxed max-w-sm text-slate-500">
          Solusi rental mobil terpercaya di Purwakarta sejak 2015. Mobil lengkap, harga transparan, dan layanan siap membantu perjalanan Anda kapan saja.
        </p>
  ...
  ['Riwayat Pemesanan', route('bookings.check-form'), 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
        ...
        <div>
          ...
          <ul class="space-y-3.5">
            ...
            {{-- Lokasi --}}
            <li>
              <a href="https://maps.google.com/?cid=15493089767721342266&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAMYASAF&hl=en&gl=ID&source=embed" target="_blank" class="group flex items-start gap-3 transition-all duration-200">
                ...
                <div>
                  ...
                  <p class="text-sm font-medium leading-snug transition-colors duration-200 text-slate-500 group-hover:text-slate-200">
                    Jl. Kolonel Rahmat, Citalang, Kec. Purwakarta, Kabupaten Purwakarta, Jawa Barat 41172
                  </p>
                </div>
              </a>
            </li>
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 py-8 border-b border-white/[0.06]">
      ...
      <a href="https://wa.me/6281234567890" target="_blank"
        class="flex-shrink-0 inline-flex items-center gap-2.5 px-6 py-3 rounded-xl font-bold text-sm text-white transition-all duration-300 hover:-translate-y-0.5 bg-gradient-to-br from-green-600 to-green-700 shadow-green-600/35 hover:shadow-sm hover:shadow-green-600/50">
