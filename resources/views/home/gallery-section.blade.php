...
<section class="py-24 bg-gray-50 relative overflow-hidden" id="gallery">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
            class="flex overflow-x-auto pb-8 gap-6 snap-x snap-mandatory hide-scrollbar sm:columns-2 lg:columns-3 sm:block sm:space-y-6 lg:space-y-6">
            ...
            @for ($i = 1; $i <= 12; $i++)
                <div
                    ...
                    {{-- Overlay --}}
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent opacity-100 sm:opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-6">
