<x-admin-layout title="Edit Profil">
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-extrabold text-gray-900 tracking-tight leading-tight">Profile Saya</h2>
                <p class="text-xs text-gray-400 mt-0.5 flex items-center gap-1.5">
                    <span class="inline-block w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                    <span>Kelola pengaturan akun Anda</span>
                </p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="relative p-6 sm:p-8">
                ...
                <form method="post" action="{{ route('password.update') }}" class="space-y-5" x-data="{
                    ...
                    <div class="group/field">
                        <x-input-label for="update_password_current_password" :value="__('Kata Sandi Saat Ini')" class="block text-sm font-semibold text-gray-700 mb-2
