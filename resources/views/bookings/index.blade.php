<x-app-layout title="Riwayat Pemesanan">
  <x-slot name="header">
    <div class="flex items-center justify-between">
      ...
      @if(!$bookings->isEmpty())
        <span
          class="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 text-emerald-600 text-sm font-semibold rounded-full border border-emerald-100">
            ...
            <div
              ...
              <div class="relative h-44 bg-gradient-to-br from-gray-100 to-gray-200
                ...
                <div class="absolute bottom-3 left-3">
                  <span
                    class="inline-flex items-center px-2.5 py-1 rounded-full text-[11px]
