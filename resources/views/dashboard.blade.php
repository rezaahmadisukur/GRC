<x-admin-layout>
  ...
  <style>
    ...
    .fade-up { opacity:0; animation:fadeInUp .45s ease forwards; }
    ...
    .tbl-row:hover { background:#f8fffe; }
      ...
      <div class="lg:col-span-2 glass rounded-2xl p-6">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50
            ...
            <span class="live-dot" style="color:#10b981"></span>
            Live
          </div>
        </div>
        <div class="h-60">
